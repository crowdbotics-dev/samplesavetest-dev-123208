"""
Django settings for samplesavetest_dev_123208 project.
...
ROOT_URLCONF = 'samplesavetest_dev_123208.urls'
...
WSGI_APPLICATION = 'samplesavetest_dev_123208.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samplesavetest_dev_123208 API",
    "DESCRIPTION": "API documentation for samplesavetest_dev_123208 App",
    "VERSION": "v1",
}
