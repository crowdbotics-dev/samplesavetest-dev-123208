...
## Project Structure
    ...
    ├── samplesavetest_dev_123208  # Django project configurations
...
1. Clone this repo and `cd samplesavetest_dev_123208`
...
2. Clone this repo and `cd samplesavetest_dev_123208`
